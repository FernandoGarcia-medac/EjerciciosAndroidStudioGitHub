...
public class Pregunta4Activity extends AppCompatActivity {
    ...
    private final String RESPUESTA_CORRECTA = "Paco Gento";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(Pregunta4Activity.this, "Debes seleccionar una respuesta.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (respuestaElegida.equals(RESPUESTA_CORRECTA)) {
                    ...
                    Toast.makeText(Pregunta4Activity.this, "¡CORRECTO! +1 punto.", Toast.LENGTH_SHORT).show();
                } else {
                    playSound(R.raw.mal);
                    Toast.makeText(Pregunta4Activity.this, "INCORRECTO.", Toast.LENGTH_LONG).show();
                }

                Intent intentSiguiente = new Intent(Pregunta4Activity.this, Pregunta5Activity.class);
